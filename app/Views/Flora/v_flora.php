                ...
                <div class="card-body">
                    <form class="form-horizontal form-material">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-line" name="or_name_org">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Latin Name of Flora</label>
                                ...
                                <!-- /.End Latin Name of Flora -->
                            </div>

                            <!-- Types of Flora -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Types of Flora</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="select2bs4" name="or_eksitu" multiple="multiple" data-placeholder="Select area" style="width: 100%;">
                                    ...
                                    <option>Stasiun Flora dan Fauna Bunder</option>
